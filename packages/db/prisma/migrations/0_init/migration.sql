-- CreateEnum
CREATE TYPE "PriceInterval" AS ENUM ('WEEK', 'MONTH', 'YEAR', 'LIFETIME');
...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'IN_REVIEW', 'CHANGES_REQUESTED', 'DONE');
...
CREATE TABLE "Plan" (
    ...
    "maxBoardsPerWorkspace" INTEGER NOT NULL,
    "maxMembersPerBoard" INTEGER NOT NULL,
    "maxActiveBoards" INTEGER NOT NULL,
